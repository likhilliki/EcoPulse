...
Connect Wallet - Link your Cardano wallet (Eternl/Nami/MetaMask)
Claim Rewards - Click "Claim Hourly AQI Reward" button to earn tokens based on current air quality
View Stats - Check verification history, total tokens earned, and verification scores
Swap Tokens - Exchange ECO tokens for ADA through the Token Swap interface
Dashboard Features
